...
- `public/js/owner.js` — Owner view (dashboard stats, real event-log activity feed, Team/grant panel, join-request approval, buyer-request approval, approval-setting toggle, order approval/status tabs, read-only per-order detail/timeline — see "Owner order visibility" below)
