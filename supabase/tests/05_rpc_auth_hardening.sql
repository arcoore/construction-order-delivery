...
select throws_ok(
  format($$ select tests.edit_order_1(%L, 1, 'p1', 'Cement', '25kg bag', 5, 'bag', 'SW1A 1AA', null, null, %L, 'b1', 'M', 'm.co.uk', 'SW1 1AA', 'today', 6.75, null, null) $$,
...
select throws_ok(
  format($$ select tests.create_order_1(%L, %L, 'p1', 'Cement', '25kg bag', 5, 'bag', 'SW1A 1AA', null, null, 'b1', 'M', 'm.co.uk', 'SW1 1AA', 'today', 6.75, null, null) $$,
    gen_random_uuid(), gen_random_uuid()),
  '42501', null,
...
select tests.authenticate_as(:'worker_e_a');
select tests.create_order_1(:'company_e', :'site_e', 'p1', 'Cement', '25kg bag', 5, 'bag', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) as order_result_e \gset
