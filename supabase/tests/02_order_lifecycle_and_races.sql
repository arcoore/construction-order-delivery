...
select throws_ok(
  format($$ select tests.create_order_1(%L, %L, 'p1', 'Cement', '25kg', 5, 'bag', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) $$,
    :'company_c', :'site_c'),
  '42501', null,
...
select tests.authenticate_as(:'worker_c');
select tests.create_order_1(:'company_c', :'site_c', 'p1', 'Cement', '25kg', 5, 'bag', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) as order_result \gset
...
select tests.authenticate_as(:'worker_c');
select tests.create_order_1(:'company_c', :'site_c', 'p2', 'Sand', '25kg', 3, 'bag', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 4.50, null, null) as order2_result \gset
...
select tests.authenticate_as(:'worker_c');
select tests.create_order_1(:'company_c', :'site_c', 'p3', 'Drill', 'Body only', 1, 'each', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 89.00, null, null) as order3_result \gset
