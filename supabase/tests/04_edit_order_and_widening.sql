...
-- ---------------------------------------------------- fixture order
select tests.authenticate_as(:'worker_d');
select tests.create_order_1(:'company_d', :'site_d', 'p1', 'Cement', '25kg bag', 5, 'bag', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) as order_result \gset
...
select throws_ok(
  format($$ select tests.edit_order_1(%L, %L, 'p1', 'Cement', '25kg bag', 9, 'bag', 'SW1A 1AA', null, null, %L, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) $$,
...
select tests.authenticate_as(:'worker_d');
select tests.edit_order_1(:'order_id', :'order_version', 'p1', 'Cement', '25kg bag', 9, 'bag', 'SW1A 1AA', null, null, :'site_d', 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) as edit_result \gset
...
select tests.edit_order_1(:'order_id', :'approved_version', 'p1', 'Cement', '25kg bag', 12, 'bag', 'SW1A 1AA', null, null, :'site_d', 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) as reapprove_result \gset
...
select tests.authenticate_as(:'worker_d');
select throws_ok(
  format($$ select tests.edit_order_1(%L, %L, 'p1', 'Cement', '25kg bag', 20, 'bag', 'SW1A 1AA', null, null, %L, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) $$,
...
select throws_ok(
  format($$ select tests.edit_order_1(%L, %L, 'p1', 'Cement', '25kg bag', 5, 'bag', 'SW1A 1AA', null, null, %L, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', -1, null, null) $$,
    :'order_id', :'current_version', :'site_d'),
  '22023', null,
  'a negative unit_price is refused by _validate_items server-side (migration 0030), regardless of what the browser sends'
);
