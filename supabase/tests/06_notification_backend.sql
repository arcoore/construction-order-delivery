...
select tests.set_membership_status(:'company_e', :'worker_e', 'approved', :'owner_e');
select tests.set_membership_status(:'company_e', :'buyer_e', 'approved', :'owner_e');
select tests.set_membership_status(:'company_e', :'same_name_1', 'approved', :'owner_e');
select tests.set_membership_status(:'company_e', :'same_name_2', 'approved', :'owner_e');
select tests.authenticate_as(:'owner_e');
...
-- ================================================================
select tests.authenticate_as(:'worker_e');
select tests.create_order_1(:'company_e', :'site_e', 'p1', 'Cement', '25kg bag', 5, 'bag', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 6.75, null, null) as order_result \gset
...
select tests.authenticate_as(:'worker_e');
select tests.create_order_1(:'company_e', :'site_e', 'p2', 'Timber', '2.4m', 3, 'length', 'SW1A 1AA', null, null, 'b1', 'Merchant', 'merchant.co.uk', 'SW1 1AA', 'today', 4.50, null, null) as order_result2 \gset
